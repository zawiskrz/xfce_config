...
echo "📦 Instalacja środowiska Openbox + XFCE Panel..." | tee -a "$LOGFILE"
sudo apt install -y \
openssh-server ufw \
...
bluez blueman \
xfce4-power-manager xfce4-appfinder xfce4-settings xfce4-terminal \
xfce4-panel xfce4-whiskermenu-plugin xfce4-pulseaudio-plugin xfce4-datetime-plugin xfce4-systemload-plugin \
...
echo "🛡️ Konfiguracja zapory sieciowej UFW..." | tee -a "$LOGFILE"
...
echo "✅ Instalacja zakończona. Środowisko Openbox z panelem XFCE zostało skonfigurowane." | tee -a "$LOGFILE"
